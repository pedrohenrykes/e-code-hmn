use mysql;
drop database db_templatefive;
create database db_templatefive;
use db_templatefive;
...
CREATE TABLE system_user (
    ...
    email varchar(100),
    frontpage_id bigint(20), system_unit_id bigint(20) references system_unit(id), active char(1),
...
CREATE TABLE system_user_group (
    id bigint(20) PRIMARY KEY NOT NULL,
    system_user_id bigint(20),
    system_group_id bigint(20),
...
(
    ...
    title TEXT,
    description TEXT,
    category_id bigint(20) references system_document_category(id),
...
(
    id bigint(20) PRIMARY KEY NOT NULL,
    document_id bigint(20) references system_document(id),
    system_user_id bigint(20)
);
