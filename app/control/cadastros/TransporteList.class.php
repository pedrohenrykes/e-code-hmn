...
class TransporteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_transporte" );
        $this->form->setFormTitle( "Listagem Transporte" );
        ...
        $this->form->addAction( "Novo", new TAction( [ "TransporteForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $column_nometransporte = new TDataGridColumn( "nometransporte", "Transporte", "left" );

        $this->datagrid->addColumn( $column_nometransporte );

        $action_edit = new TDataGridAction( [ "TransporteForm", "onEdit" ] );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "TransporteRecord" );
