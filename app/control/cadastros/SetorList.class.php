...
class SetorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_locais" );
        $this->form->setFormTitle( "Listagem dos Setores" );
        ...
        $opcao->addItems( [ "nomesetor" => "Setor", "situacao" => "Situação" ] );

        $this->form->addFields( [ new TLabel( "Opção de busca:" ) ], [ $opcao ] );
        $this->form->addFields( [ new TLabel( "Dados à buscar:" )  ], [ $dados ] );

        $this->form->addAction( "Buscar", new TAction( [ $this, "onSearch" ] ), "fa:search" );
        $this->form->addAction( "Novo", new TAction( [ "SetorForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $column_nomesetor = new TDataGridColumn( "nomesetor", "Setor", "left" );        
        $column_situacao = new TDataGridColumn( "situacao", "Situação", "left" );


        $this->datagrid->addColumn( $column_nomesetor );        
        $this->datagrid->addColumn( $column_situacao );


        $action_edit = new TDataGridAction( [ "SetorForm", "onEdit" ] );
