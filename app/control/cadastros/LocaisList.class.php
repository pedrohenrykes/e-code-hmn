...
class LocaisList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle( "Listagem dos Locais" );
        ...
        $opcao->addItems( [ "nomelocal" => "Locais", "situacao" => "Situação" ] );
        ...
        $column_nomelocal = new TDataGridColumn( "nomelocal", "Locais", "left" );        
        $column_situacao = new TDataGridColumn( "situacao", "Situação", "left" );


        $this->datagrid->addColumn( $column_nomelocal );        
        $this->datagrid->addColumn( $column_situacao );


        $action_edit = new TDataGridAction( [ "LocaisForm", "onEdit" ] );
