...
class DestinoObitoList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_destino_obito" );
        $this->form->setFormTitle( "Listagem Destinos de Óbito" );
        ...
        $opcao->addItems( [ "nomedestinoobito" => "Destino", "situacao" => "Situação" ] );

        $this->form->addFields( [ new TLabel( "Opção de busca:" ) ], [ $opcao ] );
        $this->form->addFields( [ new TLabel( "Dados à buscar:" )  ], [ $dados ] );

        $this->form->addAction( "Buscar", new TAction( [ $this, "onSearch" ] ), "fa:search" );
        $this->form->addAction( "Novo", new TAction( [ "DestinoObitoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $action_edit = new TDataGridAction( [ "DestinoObitoForm", "onEdit" ] );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "DestinoObitoRecord" );
