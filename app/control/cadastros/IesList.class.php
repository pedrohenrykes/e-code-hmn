...
class IesList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder("form_list_ies" );
        $this->form->setFormTitle( "Listagem da Instituição de Ensino Superior" );
        ...
        $column_nomeies  = new TDataGridColumn( "nomeies", "Instituição", "left" );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( 'IesRecord' );
