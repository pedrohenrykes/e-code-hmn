...
class ConvenioList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle( "Listagem de Convênios" );
        ...
        $this->form->addAction( "Novo", new TAction( [ "ConvenioForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $action_edit = new TDataGridAction( [ "ConvenioForm", "onEdit" ] );
