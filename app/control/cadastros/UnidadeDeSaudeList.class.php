...
class UnidadeDeSaudeList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_UnidadeDeSaude" );
        $this->form->setFormTitle( "Listagem das unidades de saúde" );
        ...
        $opcao->addItems( [ "nomeunidade" => "Nome Unidade", "endereco" => "Endereço", "bairro" => "Bairro", "cidade" => "Cidade", "cep" => "CEP", "uf" => "UF", "latitude" => "Latitude", "longitude" => "Longitude" ] );

        $this->form->addFields( [ new TLabel( "Opção de busca:" ) ], [ $opcao ] );
        $this->form->addFields( [ new TLabel( "Dados à buscar:" )  ], [ $dados ] );

        $this->form->addAction( "Buscar", new TAction( [ $this, "onSearch" ] ), "fa:search" );
        $this->form->addAction( "Novo", new TAction( [ "UnidadeDeSaudeForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $column_nomeunidade = new TDataGridColumn( "nomeunidade", "Nome da unidade", "left" ); 
        ...
        //$column_nomeunidadedesaude = new TDataGridColumn( "nomeunidadedesaude", "UnidadeDeSaude", "left" );        
        //$column_situacao = new TDataGridColumn( "situacao", "Situação", "left" );


        $this->datagrid->addColumn( $column_nomeunidade ); 
        ...
        //$this->datagrid->addColumn( $column_nomeunidadedesaude );        
        //$this->datagrid->addColumn( $column_situacao );


        $action_edit = new TDataGridAction( [ "UnidadeDeSaudeForm", "onEdit" ] );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "UnidadeDeSaudeRecord" );
