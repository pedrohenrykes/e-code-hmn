...
class  GeraMedicamentoAplicado extends TPage{
  private $form;
  private $datagrid;
  ...
  public function __construct()
  {
    ...
    $this->form->setFormTitle( "Relatório Medicamentos Aplicados" );
    ...
    $criteria->setProperty('order', 'bau_id');
  ...
  function onGenerate(){
    ...
    try{
      new RelatorioMedicamentoAplicadoPDF();
    }catch( Exception $e ){
