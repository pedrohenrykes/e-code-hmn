...
class TipoAltaHospitalarList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "tipo_alta_hospitalar" );
        $this->form->setFormTitle( "Listagem de Tipo Alta Hospitalar" );
        ...
        $opcao->addItems( [ "nometipoaltahospitalar" => "Tipo Alta Hospitalar" ] );
        ...
        $column_tipoaltahospitalar = new TDataGridColumn( "nometipoaltahospitalar", "Tipo Alta Hospitalar ", "left" );
       
        $this->datagrid->addColumn( $column_tipoaltahospitalar );
