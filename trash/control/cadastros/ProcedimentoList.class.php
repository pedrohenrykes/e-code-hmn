...
class ProcedimentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_procedimento" );
        ...
        $opcao->addItems( [ "nomeprocedimento" => "Procedimento" ] );
        ...
        $this->form->addAction( "Novo", new TAction( [ "ProcedimentoForm", "onEdit" ] ), "bs:plus-sign green" );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "ProcedimentoRecord" );
    ...
    public function onSearch()
    {
        ...
        try {
            ...
            if( !empty( $data->opcao ) && !empty( $data->dados ) ) {
                ...
                if ( $data->opcao ==  "nomeprocedimento" ) {
